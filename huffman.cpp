...
HuffmanNode* create_huffman_tree(string file){
	...
	else{ cout << "The frequency file name is either spelled wrong or it does not exist. Try again" << endl;}
...
void runEncoding()
{
  ...
  /* Your implementation */
	...
	else{ cout << "The input file name is either spelled wrong or it does not exist. Try again" << endl;}
...
void runDecoding()
{
  ...
  /* Your implementation */
	ifbstream ifbs;
	openFile(ifbs, inEncodeFileName);
	if(ifbs.is_open()){
	...
	else{ cout << "The encoded file name is either spelled wrong or it does not exist. Try again" << endl;}
}
